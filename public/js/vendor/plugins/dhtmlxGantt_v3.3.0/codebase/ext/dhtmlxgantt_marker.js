...
var t=[];for(var e in this._markers)t.push(this._markers[e]);return this._markerRenderer.render_items(t),!0};gantt.addMarker({start_date: new Date(), css: "today", text: "现在"});
