$(function () {
    ...
    var dt = $('#tab').DataTable({
        ajax:{
            url:"../admin/internalForm/list?subForm=gk",
            type:"GET"
        },
        serverSide:'true',
        paging:true,
    ...
    $("#tab").on("click", "a", function (e) {
        var id = $(this).attr("id");
        $.post("../admin/internalForm/get?subForm=gk", {id: id}, function (data) {
            $('#submit').hide();
            $('#update,#delete').show();
            ...
            buttons: [
                ...
                },
                {
                    ...
                    callback: function () {
                        ...
                        $.ajax(
                            {
                                url: "../admin/internalForm/del?subForm=gk",
                                type: "DELETE",
                                data: {id: id}
                            }).success(function () {
    ...
    $('form').formValidation({
        ...
        if(handle=="create"){
            $.ajax({
                url: "../admin/internalForm/create?subForm=gk",
                type: 'POST',
                data: $form.serialize()
            ...
            $.ajax({
                url: "../admin/internalForm/update?subForm=gk",
                type: 'POST',
