$(function () {
        ...
        var gxqScyqCpyqSxfsDtTable, $gxqScyqCpyqSxfsTable = $(".arrange #gxq_scyq_cpyq_sxfs table.gxq_scyq_cpyq_sxfs");
        ...
        var gxqScyqJxylZxsGgDtTable, $gxqScyqJxylZxsGgTable = $(".arrange #gxq_scyq_jxyl_zxs_gg  table.gxq_scyq_jxyl_zxs_gg");
        var gxqScyqJxylZxsYlDtTable, $gxqScyqJxylZxsYlTable = $(".arrange #gxq_scyq_jxyl_zxs_yl  table.gxq_scyq_jxyl_zxs_yl");
        ...
        var gxhScyqJxylZxsGgDtTable, $gxhScyqJxylZxsGgTable = $(".arrange #gxh_scyq_jxyl_zxs_gg_index  table.gxh_scyq_jxyl_zxs_gg_index");
        var gxhScyqJxylZjpGgDtTable, $gxhScyqJxylZjpGgTable = $(".arrange #gxh_scyq_jxyl_zjp_gg_index  table.gxh_scyq_jxyl_zjp_gg_index");
        var xwxExist, yzExist, zxsExist, wgsExist, sdcExist, sExist, zjpExist, zjpText, sjclExist;
        ...
        function setupEventHandlers() {
            $(".delete", $treeHeader).on("click", function (e) {
                ...
                var message = $(tr).attr("status") == "已下发" ? "作业计划已下发，确认要删除吗？" : "确认删除作业计划吗?";
                bootbox.confirm(
                    {
                        message: message,
            ...
            $('.arrange').on('input propertychange', 'input', function (e) {
                ...
                var aqxs = $(tr).find("input[name='aqxs']");
                ...
                if (aqxs.length > 0) {
                    if (name == "dc" || name == "ds" || name == "aqxs" || name == "js") {
                        $(djmc).val(accMul($(dc).val(), $(ds).val()));
                        $(djxqmc).val(accMul($(djmc).val(), $(aqxs).val()));
                        $(zmc).val(accMul($(djmc).val(), $(js).val()));
                        $(zxqmc).val(accMul($(djxqmc).val(), $(js).val()));
                    }
                }
                else {
                    if (djmc.length > 0) {
            ...
            $('.main .arrangeBtn').on('click', function (e) {
                ...
                $(".arrange .gxq_scyq_jxyl_zxs").hide();
                ...
                $(".arrange .gxh_scyq_jxyl_zxs_index").hide();
                $(".arrange .gxh_scyq_jxyl_yz_index").hide();
                $(".arrange .gxh_scyq_jxyl_zjp_index").hide();
                $(".arrange .gxh_scyq_jxyl_xwx_index").hide();
                $(".arrange .gxq_scyq_jxyl_wgs").remove();
                $(".arrange .gxh_scyq_jxyl_wgs_index").remove();
                $(".arrange .gxq_scyq_jxyl_sdc").remove();
                $(".arrange .gxh_scyq_jxyl_sdc_index").remove();
                $(".arrange .gxq_scyq_jxyl_s").remove();
                $(".arrange .gxh_scyq_jxyl_s_index").remove();
                $(".arrange .gxh_scyq_cpyq_sxfs_index").remove();
                ...
                gxqScyqCpyqSxfsDtTable.fnClearTable();
                ...
                gxqScyqJxylZxsGgDtTable.fnClearTable();
                gxqScyqJxylZxsYlDtTable.fnClearTable();
                ...
                gxhScyqJxylZxsGgDtTable.fnClearTable();
                gxhScyqJxylZjpGgDtTable.fnClearTable();
                $.getJSON("../user/formInstById?id=" + $(trs[0]).attr("id"), function (data) {
                    cache = {};
                    arrangeData = data;
                    sdcExist = getFromNode("scs", data, "scyq.jxyl") ? true : false;
                    sExist = getFromNode("ss", data, "scyq.jxyl") ? true : false;
                    zxsExist = checkNodeExist(data, "scyq.jxyl.zxs");
                    ...
                    if (wgsExist) {
                        var qHtml = "";
                        var hHtml = "";
                        qHtml += "<div class='panel panel-default gxq_scyq_jxyl_wgs>";
                        hHtml += "<div class='panel panel-default gxh_scyq_jxyl_wgs_index>";
                        ...
                        qHtml += "href='#gxq_scyq_jxyl_wgs' style='font-size:14px;font-weight:bold'>";
                        hHtml += "href='#gxh_scyq_jxyl_wgs_index' style='font-size:14px;font-weight:bold'>";
                        qHtml += getFromNode("text", data, "scyq.jxyl.wgs");
                        hHtml += getFromNode("text", data, "scyq.jxyl.wgs");
                        qHtml += "</a>";
                        hHtml += "</a>";
                        qHtml += "</div>";
                        hHtml += "</div>";
                        qHtml += "</div>";
                        hHtml += "</div>";
                        qHtml += "<div class='panel-collapse collapse' id='gxq_scyq_jxyl_wgs'>";
                        hHtml += "<div class='panel-collapse collapse' id='gxh_scyq_jxyl_wgs_index'>";
                        ...
                        var ss = getFromNode("ss", data, "scyq.jxyl.wgs");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            ...
                            qHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            hHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            qHtml += "href='#gxq_scyq_jxyl_wgs_s";
                            hHtml += "href='#gxh_scyq_jxyl_wgs_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "' style='font-size:14px;font-weight:bold'>";
                            hHtml += "_index' style='font-size:14px;font-weight:bold'>";
                            qHtml += getFromNode("text", data, "scyq.jxyl.wgs.s" + i);
                            hHtml += getFromNode("text", data, "scyq.jxyl.wgs.s" + i);
                            qHtml += "</a>";
                            hHtml += "</a>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "<div class='panel-collapse collapse' id='gxq_scyq_jxyl_wgs_s";
                            hHtml += "<div class='panel-collapse collapse' id='gxh_scyq_jxyl_wgs_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "'>";
                            hHtml += "_index'>";
                            ...
                            qHtml += "gxq_scyq_jxyl_wgs_s";
                            hHtml += "gxh_scyq_jxyl_wgs_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "_gg'>";
                            hHtml += "_gg_index'>";
                            ...
                            qHtml += "<tr role='row'>";
                            hHtml += "<tr role='row'>";
                            qHtml += "<th tabindex='0',rowspan='1', colspan='1'> 类别</th>";
                            hHtml += "<th tabindex='0',rowspan='1', colspan='1'> 类别</th>";
                            ...
                            qHtml += "<th tabindex='0' rowspan='1'  colspan='1'> 安全系数</th>";
                            hHtml += "<th tabindex='0' rowspan='1'  colspan='1'> 安全系数</th>";
                    ...
                    if (sdcExist) {
                        var scs = getFromNode("scs", data, "scyq.jxyl");
                        for (var i = scs.begin; i < scs.begin + scs.total; i++) {
                            var qHtml = "";
                            var hHtml = "";
                            qHtml += "<div class='panel panel-default gxq_scyq_jxyl_sdc gxq_scyq_jxyl_sdc";
                            hHtml += "<div class='panel panel-default gxh_scyq_jxyl_sdc_index gxh_scyq_jxyl_sdc";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "'>";
                            hHtml += "_index'>";
                            ...
                            qHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            hHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            qHtml += "href='#gxq_scyq_jxyl_sdc";
                            hHtml += "href='#gxh_scyq_jxyl_sdc";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "' style='font-size:14px;font-weight:bold'>";
                            hHtml += "_index' style='font-size:14px;font-weight:bold'>";
                            qHtml += getFromNode("text", data, "scyq.jxyl.sdc" + i);
                            hHtml += getFromNode("text", data, "scyq.jxyl.sdc" + i);
                            qHtml += "</a>";
                            hHtml += "</a>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "<div class='panel-collapse collapse' id='gxq_scyq_jxyl_sdc";
                            hHtml += "<div class='panel-collapse collapse' id='gxh_scyq_jxyl_sdc";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "'>";
                            hHtml += "_index'>";
                            ...
                            qHtml += "<div class='panel-group accordion'>";
                            hHtml += "<div class='panel-group accordion'>";
                            var ss = getFromNode("ss", data, "scyq.jxyl.sdc" + i);
                            for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                                ...
                                qHtml += "' style='font-size:14px;font-weight:bold'>";
                                hHtml += "_index' style='font-size:14px;font-weight:bold'>";
                                qHtml += getFromNode("text", data, "scyq.jxyl.sdc" + i + ".s" + j);
                                hHtml += getFromNode("text", data, "scyq.jxyl.sdc" + i + ".s" + j);
                                qHtml += "</a>";
                                hHtml += "</a>";
                                qHtml += "</div>";
                                hHtml += "</div>";
                                ...
                                qHtml += "<table class='table table-striped table-hover table-bordered dataTable no-footer ";
                                hHtml += "<table class='table table-striped table-hover table-bordered dataTable no-footer ";
                                qHtml += "gxq_scyq_jxyl_sdc";
                                hHtml += "gxh_scyq_jxyl_sdc";
                                qHtml += i;
                                hHtml += i;
                                qHtml += "_s";
                                hHtml += "_s";
                    ...
                    if (sExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var qHtml = "";
                            var hHtml = "";
                            qHtml += "<div class='panel panel-default gxq_scyq_jxyl_s'>";
                            hHtml += "<div class='panel panel-default gxh_scyq_jxyl_s_index'>";
                            qHtml += "<div class='panel-heading'>";
                            hHtml += "<div class='panel-heading'>";
                            qHtml += "<div class='panel-title' style='font-size:14px'>";
                            hHtml += "<div class='panel-title' style='font-size:14px'>";
                            qHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            hHtml += "<a class='accordion-toggle accordion-toggle-styled collapsed' data-toggle='collapse' ";
                            qHtml += "href='#gxq_scyq_jxyl_s";
                            hHtml += "href='#gxh_scyq_jxyl_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "' style='font-size:14px;font-weight:bold'>";
                            hHtml += "_index' style='font-size:14px;font-weight:bold'>";
                            qHtml += getFromNode("text", data, "scyq.jxyl.s" + i);
                            hHtml += getFromNode("text", data, "scyq.jxyl.s" + i);
                            qHtml += "</a>";
                            hHtml += "</a>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "</div>";
                            hHtml += "</div>";
                            qHtml += "<div class='panel-collapse collapse' id='gxq_scyq_jxyl_s";
                            hHtml += "<div class='panel-collapse collapse' id='gxh_scyq_jxyl_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "'>";
                            hHtml += "_index'>";
                            ...
                            qHtml += "<table class='table table-striped table-hover table-bordered dataTable no-footer ";
                            hHtml += "<table class='table table-striped table-hover table-bordered dataTable no-footer ";
                            qHtml += "gxq_scyq_jxyl_s";
                            hHtml += "gxh_scyq_jxyl_s";
                            qHtml += i;
                            hHtml += i;
                            qHtml += "_gg'>";
                            hHtml += "_gg_index'>";
                    ...
                    if (zxsExist) {
                        $(".arrange #gxh_scyq_jxyl_zxs_yl_index .dataTables_wrapper.no-footer").empty();
                        var html = "";
                        html += "<table class='table table-striped table-hover table-bordered dataTable no-footer gxh_scyq_jxyl_zxs_yl_index'>";
                        html += "<thead>";
                        html += "<tr role='row'>";
                        ...
                        html += "<th tabindex='0',rowspan='1', colspan='1'> 安全系数</th>";
                        ...
                        html += "</thead>";
                        html += "</table>";
                        $(".arrange .gxq_scyq_jxyl_zxs").show();
                        $(".arrange .gxh_scyq_jxyl_zxs_index").show();
                        $(".arrange #gxh_scyq_jxyl_zxs_yl_index .dataTables_wrapper.no-footer").html(html);
                    }
                    if (zjpExist) {
                    ...
                    var html = "";
                    html += "<table class='table table-striped table-hover table-bordered dataTable no-footer gxh_scyq_cpyq_sxfs_index'>";
                    html += "<thead>";
                    html += "<tr role='row'>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 段长(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 段数</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 单件米长(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 单件损耗(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 单件生产米长(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 件数</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 总米长(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 总损耗(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 总生产米长(m)</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 工字轮型号</th>";
                    html += "<th tabindex='0',rowspan='1', colspan='1'> 操作</th>";
                    html += "</tr>";
                    html += "</thead>";
                    html += "</table>";
                    $(".arrange #gxh_scyq_cpyq_sxfs_index .dataTables_wrapper.no-footer").html(html);
                    var rowValues = [];
                    var array = [
                        {"name": "xdrq"},
                        {"name": "gdzzh"},
                    ...
                    var sxfss = getFromNode("sxfss", data, "scyq.cpyq.sxfs");
                    var array = ["dc", "ds", "djmc", "djsh", "djscmc", "js", "zmc", "zsh", "zscmc", "gzlxh"];
                    ...
                    var gxhScyqJxylZxsYlData = [];
                    if (zxsExist) {
                        var rowValues = [];
                        var array = ["lb", "zj", "qd"];
                        for (var i = 0; i < array.length; i++) {
                            rowValues.push(getFromNode("value", data, "scyq.jxyl.zxs.gg." + array[i]) || "");
                        }
                        gxqScyqJxylZxsGgDtTable.fnAddData(rowValues);
                        gxhScyqJxylZxsGgDtTable.fnAddData(rowValues);
                        var yls = getFromNode("yls", data, "scyq.jxyl.zxs.yl");
                        for (var i = yls.begin; i < yls.begin + yls.total; i++) {
                            var rowValues = [];
                            var array = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                            for (j = 0; j < array.length; j++) {
                                rowValues.push(getFromNode("value", data, "scyq.jxyl.zxs.yl.yl" + i + "." + array[j]) || "");
                            }
                            gxqScyqJxylZxsYlDtTable.fnAddData(rowValues);
                            for (var j = 0; j < rowValues.length; j++) {
                                rowValues[j] = "<input type='text' class='form-control input-sm' name='" + array[j] +
                                    "' value='" + rowValues[j] + "' ";
                                if (array[j] == "djmc" ||
                            ...
                            rowValues.push("<button class='btn btn-sm red'>删除</button>");
                            gxhScyqJxylZxsYlData.push(rowValues);
                        }
                    }
                    ...
                    if (sdcExist) {
                        ...
                        for (var i = scs.begin; i < scs.begin + scs.total; i++) {
                            var ss = getFromNode("ss", data, "scyq.jxyl.sdc" + i);
                            for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                                var qGgTable = $(".arrange " + ".gxq_scyq_jxyl_sdc" + i + "_s" + j + "_gg");
                                var hGgTable = $(".arrange " + ".gxh_scyq_jxyl_sdc" + i + "_s" + j + "_gg_index");
                                var qGgDtTable = qGgTable.dataTable(datatableOption);
                                var hGgDtTable = hGgTable.dataTable(datatableOption);
                                var qYlTable = $(".arrange " + ".gxq_scyq_jxyl_sdc" + i + "_s" + j + "_yl");
                                var qYlDtTable = qYlTable.dataTable(datatableOption);
                                var rowValues = [];
                                var array = ["lb", "zj", "qd"];
                                for (var k = 0; k < array.length; k++) {
                                    rowValues.push(getFromNode("value", data, "scyq.jxyl.sdc" + i + ".s" + j + ".gg." + array[k]) || "");
                                }
                                qGgDtTable.fnAddData(rowValues);
                                hGgDtTable.fnAddData(rowValues);
                                var yls = getFromNode("yls", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl");
                                for (var l = yls.begin; l < yls.begin + yls.total; l++) {
                                    var rowValues = [];
                                    var array = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                                    rowValues.push(getFromNode("value", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl.gs") || "");
                                    for (var m = 0; m < array.length; m++) {
                                        rowValues.push(getFromNode("value", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl.yl" + l + "." + array[m]) || "");
                                    }
                    ...
                    if (sExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var qGgTable = $(".arrange " + ".gxq_scyq_jxyl_s" + i + "_gg");
                            var hGgTable = $(".arrange " + ".gxh_scyq_jxyl_s" + i + "_gg_index");
                            var qGgDtTable = qGgTable.dataTable(datatableOption);
                            var hGgDtTable = hGgTable.dataTable(datatableOption);
                            var qYlTable = $(".arrange " + ".gxq_scyq_jxyl_s" + i + "_yl");
                            var qYlDtTable = qYlTable.dataTable(datatableOption);
                            var rowValues = [];
                            var array = ["lb", "zj", "qd"];
                            for (var j = 0; j < array.length; j++) {
                                rowValues.push(getFromNode("value", data, "scyq.jxyl.s" + i + ".gg." + array[j]) || "");
                            }
                            qGgDtTable.fnAddData(rowValues);
                            hGgDtTable.fnAddData(rowValues);
                            var yls = getFromNode("yls", data, "scyq.jxyl.s" + i + ".yl");
                            for (var j = yls.begin; j < yls.begin + yls.total; j++) {
                                var rowValues = [];
                                var array = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                                rowValues.push(getFromNode("value", data, "scyq.jxyl.s" + i + ".yl.gs") || "");
                                for (var k = 0; k < array.length; k++) {
                                    rowValues.push(getFromNode("value", data, "scyq.jxyl.s" + i + ".yl.yl" + j + "." + array[k]) || "");
                                }
                                qYlDtTable.fnAddData(rowValues);
                            }
                        }
                    ...
                    if (wgsExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl.wgs");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var qGgTable = $(".arrange " + ".gxq_scyq_jxyl_wgs_s" + i + "_gg");
                            var hGgTable = $(".arrange " + ".gxh_scyq_jxyl_wgs_s" + i + "_gg_index");
                            var qGgDtTable = qGgTable.dataTable(datatableOption);
                            var hGgDtTable = hGgTable.dataTable(datatableOption);
                            var qYlTable = $(".arrange " + ".gxq_scyq_jxyl_wgs_s" + i + "_yl");
                            var qYlDtTable = qYlTable.dataTable(datatableOption);
                            var rowValues = [];
                            var array = ["lb", "zj", "qd"];
                            for (var j = 0; j < array.length; j++) {
                                rowValues.push(getFromNode("value", data, "scyq.jxyl.wgs.s" + i + ".gg." + array[j]) || "");
                            }
                            qGgDtTable.fnAddData(rowValues);
                            hGgDtTable.fnAddData(rowValues);
                            // 用量数
                            var yls = getFromNode("yls", data, "scyq.jxyl.wgs.s" + i + ".yl");
                            for (var j = yls.begin; j < yls.begin + yls.total; j++) {
                                var rowValues = [];
                                var array = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                                rowValues.push(getFromNode("value", data, "scyq.jxyl.wgs.s" + i + ".yl.gs") || "");
                                for (var k = 0; k < array.length; k++) {
                                    rowValues.push(getFromNode("value", data, "scyq.jxyl.wgs.s" + i + ".yl.yl" + j + "." + array[k]) || "");
                                }
                                qYlDtTable.fnAddData(rowValues);
                            }
                        }
                    ...
                    if (zxsExist) {
                        var dtTable = $(".arrange .gxh_scyq_jxyl_zxs_yl_index").dataTable(datatableOption);
                        for (var i = 0; i < gxhScyqJxylZxsYlData.length; i++) {
                            dtTable.fnAddData(gxhScyqJxylZxsYlData[i]);
                        }
                    }
                    if (zjpExist) {
                    ...
                    if (sdcExist) {
                        ...
                        for (var i = scs.begin; i < scs.begin + scs.total; i++) {
                            var ss = getFromNode("ss", data, "scyq.jxyl.sdc" + i);
                            for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                                var hYlTable = $(".arrange " + ".gxh_scyq_jxyl_sdc" + i + "_s" + j + "_yl_index");
                                var hYlDtTable = hYlTable.dataTable(datatableOption);
                                var yls = getFromNode("yls", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl");
                                for (var l = yls.begin; l < yls.begin + yls.total; l++) {
                                    var rowValues = [];
                                    var array = ["gs", "dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                                    for (var m = 0; m < array.length; m++) {
                                        if (array[m] == "gs") {
                                            rowValues[m] = "<input type='text' class='form-control input-sm' name='" + array[m] +
                                                "' value='" + (getFromNode("value", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl." + array[m]) || "") +
                                                "' disabled />";
                                        }
                                        else {
                                            rowValues[m] = "<input type='text' class='form-control input-sm' name='" + array[m] +
                                                "' value='" + (getFromNode("value", data, "scyq.jxyl.sdc" + i + ".s" + j + ".yl.yl" + l + "." + array[m]) || "") +
                                                "' ";
                                            if (array[m] == "djmc" ||
                                                array[m] == "djxqmc" ||
                                                array[m] == "zmc" ||
                    ...
                    if (sExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var hYlTable = $(".arrange " + ".gxh_scyq_jxyl_s" + i + "_yl_index");
                            var hYlDtTable = hYlTable.dataTable(datatableOption);
                            var yls = getFromNode("yls", data, "scyq.jxyl.s" + i + ".yl");
                            for (var j = yls.begin; j < yls.begin + yls.total; j++) {
                                var rowValues = [];
                                ...
                                for (var k = 0; k < array.length; k++) {
                                    if (array[k] == "gs") {
                                        rowValues[k] = "<input type='text' class='form-control input-sm' name='" + array[k] +
                                            "' value='" + (getFromNode("value", data, "scyq.jxyl.s" + i + ".yl." + array[k]) || "") +
                                            "' disabled />";
                                    }
                                    else {
                                        rowValues[k] = "<input type='text' class='form-control input-sm' name='" + array[k] +
                                            "' value='" + (getFromNode("value", data, "scyq.jxyl.s" + i + ".yl.yl" + j + "." + array[k]) || "") +
                                            "' ";
                                        if (array[k] == "djmc" ||
                                            array[k] == "djxqmc" ||
                                            array[k] == "zmc" ||
                                            array[k] == "zxqmc") {
                                            rowValues[k] += "disabled";
                                        }
                                        rowValues[k] += " />";
                                    }
                                }
                                rowValues.push("<button cla" +
                                    "ss='btn btn-sm red'>删除</button>");
                                hYlDtTable.fnAddData(rowValues);
                            }
                        }
                    }
                    if (wgsExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl.wgs");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var hYlTable = $(".arrange " + ".gxh_scyq_jxyl_wgs_s" + i + "_yl_index");
                            var hYlDtTable = hYlTable.dataTable(datatableOption);
                            var yls = getFromNode("yls", data, "scyq.jxyl.wgs.s" + i + ".yl");
                            for (var j = yls.begin; j < yls.begin + yls.total; j++) {
                                var rowValues = [];
                                ...
                                for (var k = 0; k < array.length; k++) {
                                    if (array[k] == "gs") {
                                        rowValues[k] = "<input type='text' class='form-control input-sm' name='" + array[k] +
                                            "' value='" + (getFromNode("value", data, "scyq.jxyl.wgs.s" + i + ".yl." + array[k]) || "") +
                                            "' disabled />";
                                    }
                                    else {
                                        rowValues[k] = "<input type='text' class='form-control input-sm' name='" + array[k] +
                                            "' value='" + (getFromNode("value", data, "scyq.jxyl.wgs.s" + i + ".yl.yl" + j + "." + array[k]) || "") +
                                            "' ";
                                        if (array[k] == "djmc" ||
                                            array[k] == "djxqmc" ||
                                            array[k] == "zmc" ||
                    ...
                    var dtTable = $(".arrange .gxh_scyq_cpyq_sxfs_index").dataTable(datatableOption);
            ...
            $(".arrange").on('click', '.add', function (e) {
                ...
                if (className.indexOf("fpjt") > 0) {
                    ...
                    if (zxsExist) {
                        var dtTable = $(".arrange .gxh_scyq_jxyl_zxs_yl_" + index).dataTable(datatableOption);
                        var array = [];
                        var names = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                    ...
                    if (sdcExist) {
                        var scs = getFromNode("scs", arrangeData, "scyq.jxyl");
                        for (var i = scs.begin; i < scs.begin + scs.total; i++) {
                            var ss = getFromNode("ss", arrangeData, "scyq.jxyl.sdc" + i);
                            for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                                var dtTable = $(".arrange " + ".gxh_scyq_jxyl_sdc" + i + "_s" + j + "_yl_" + index).dataTable(datatableOption);
                                var array = [];
                                array.push("<input type='text' class='form-control input-sm' name='gs' value='" +
                                    $(".arrange .gxh_scyq_jxyl_sdc" + i + "_s" + j + "_yl_index" +
                    ...
                    if (sExist) {
                        var ss = getFromNode("ss", arrangeData, "scyq.jxyl");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var dtTable = $(".arrange " + ".gxh_scyq_jxyl_s" + i + "_yl_" + index).dataTable(datatableOption);
                            var array = [];
                            array.push("<input type='text' class='form-control input-sm' name='gs' value='" +
                                $(".arrange .gxh_scyq_jxyl_s" + i + "_yl_index" +
                                    " tbody tr:first input[name=gs]").val() + "' disabled/>");
                            var names = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                            for (var j = 0; j < names.length; j++) {
                                if (names[j] == "djmc" ||
                                    ...
                                    names[j] == "zmc" ||
                                    names[j] == "zxqmc") {
                                    array.push("<input type='text' class='form-control input-sm' name='" + names[j] + "' value='' disabled />");
                                }
                                else {
                                    array.push("<input type='text' class='form-control input-sm' name='" + names[j] + "' value='' />");
                                }
                            }
                            array.push("<button class='btn btn-sm red'>删除</button>");
                            dtTable.fnAddData(array);
                    ...
                    if (wgsExist) {
                        var ss = getFromNode("ss", arrangeData, "scyq.jxyl.wgs");
                        for (var i = ss.begin; i < ss.begin + ss.total; i++) {
                            var dtTable = $(".arrange " + ".gxh_scyq_jxyl_wgs_s" + i + "_yl_" + index).dataTable(datatableOption);
                            var array = [];
                            array.push("<input type='text' class='form-control input-sm' name='gs' value='" +
                                $(".arrange .gxh_scyq_jxyl_wgs_s" + i + "_yl_index" +
                                    " tbody tr:first input[name=gs]").val() + "' disabled/>");
                            var names = ["dc", "ds", "djmc", "aqxs", "djxqmc", "js", "zmc", "zxqmc", "gzlxh"];
                            for (var j = 0; j < names.length; j++) {
                                if (names[j] == "djmc" ||
                    ...
                    var dtTable = $(".arrange .gxh_scyq_cpyq_sxfs_" + index).dataTable(datatableOption);
                    var array = [];
                    var names = ["dc", "ds", "djmc", "djsh", "djscmc", "js", "zmc", "zsh", "zscmc", "gzlxh"];
                    for (i = 0; i < names.length; i++) {
                        if (names[i] == "djmc" ||
            ...
            $(".arrange #submit").on('click', function (e) {
                ...
                for (var i = 0; i < array.length; i++) {
                    if (array[i].name == "jth" || array[i].name == "bzz" || array[i].name == "cj") {
                        var selects = $gxhFpjtTable.find("select[name=" + array[i].name + "]");
                        for (var j = 0; j < selects.length; j++) {
                            var result = checkValue(array[i].name, $(selects[j]).find("option:selected").val());
                            if (!result.valid) {
                ...
                for (var i = 0; i < trs.length; i++) {
                    ...
                    if (zxsExist) {
                        ...
                        for (var j = 0; j < array.length; j++) {
                            var inputs = $(".arrange .gxh_scyq_jxyl_zxs_yl_" + index).find("input[name=" + array[j].name + "]");
                            for (var k = 0; k < inputs.length; k++) {
                                var result = checkValue(array[j].name, $(inputs[k]).val());
                                if (!result.valid) {
                                    bootboxError("生产计划更新后-生产要求-进线用料-中心丝-用量-" + array[j].text + result.text);
                                    $(".arrange #submit").removeProp("disabled");
                                    $(".arrange #cancel").removeProp("disabled");
                                    return;
                                }
                    ...
                    if (sdcExist) {
                        ...
                        for (var j = scs.begin; j < scs.begin + scs.total; j++) {
                            var ss = getFromNode("ss", arrangeData, "scyq.jxyl.sdc" + j);
                            for (var k = ss.begin; k < ss.begin + ss.total; k++) {
                                ...
                                for (var l = 0; l < array.length; l++) {
                                    var inputs = $(".arrange .gxh_scyq_jxyl_sdc" + j + "_s" + k + "_yl_" + index).find("input[name=" + array[l].name + "]");
                                    for (var m = 0; m < inputs.length; m++) {
                                        var result = checkValue(array[l].name, $(inputs[m]).val());
                                        if (!result.valid) {
                                            bootboxError("生产计划更新后-生产要求-进线用料-第" + j + "层丝-" + "丝" + k + "-用量-" +
                    ...
                    if (sExist) {
                        ...
                        for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                            ...
                            for (var k = 0; k < array.length; k++) {
                                var inputs = $(".arrange .gxh_scyq_jxyl_s" + j + "_yl_" + index).find("input[name=" + array[k].name + "]");
                                for (var l = 0; l < inputs.length; l++) {
                                    var result = checkValue(array[k].name, $(inputs[l]).val());
                                    if (!result.valid) {
                                        bootboxError("生产计划更新后-生产要求-进线用料-丝" + j + "-用量-" +
                                            array[k].text + result.text);
                                        $(".arrange #submit").removeProp("disabled");
                                        $(".arrange #cancel").removeProp("disabled");
                                        return;
                                    }
                    ...
                    if (wgsExist) {
                        ...
                        for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                            ...
                            for (var k = 0; k < array.length; k++) {
                                var inputs = $(".arrange .gxh_scyq_jxyl_wgs_s" + j + "_yl_" + index).find("input[name=" + array[k].name + "]");
                                for (var l = 0; l < inputs.length; l++) {
                                    var result = checkValue(array[k].name, $(inputs[j]).val());
                                    if (!result.valid) {
                                        bootboxError("生产计划更新后-生产要求-进线用料-外钢丝-" + "丝" + j + "-用量-" +
                                            array[k].text + result.text);
                                        $(".arrange #submit").removeProp("disabled");
                                        $(".arrange #cancel").removeProp("disabled");
                                        return;
                    ...
                    for (var j = 0; j < array.length; j++) {
                        var inputs = $(".arrange .gxh_scyq_cpyq_sxfs_" + index).find("input[name=" + array[j].name + "]");
                        for (var k = 0; k < inputs.length; k++) {
                            var result = checkValue(array[j].name, $(inputs[k]).val());
                            if (!result.valid) {
                ...
                for (var i = 0; i < gxhFpjtDtTable.fnGetNodes().length; i++) {
                    ...
                    if (xwxExist) {
                        ...
                        var inputs = $(tr).find("input");
                        for (var j = 0; j < $(inputs).length; j++) {
                            setToNode("value", data, "scyq.jxyl.xwx.yl." + $(inputs[j]).attr("name"), $(inputs[j]).val());
                        }
                    }
                    if (zxsExist) {
                        setToNode("children", data, "scyq.jxyl.zxs.yl", $.extend(true, [], getFromNode("children", module, "scyq.jxyl.zxs.yl")))
                        tree.expire(data);
                        var trs = $(".arrange .gxh_scyq_jxyl_zxs_yl_" + index).find("tbody tr:has(td:not(.dataTables_empty))");
                        drawNode(trs.length, getFromNode("json", data, "scyq.jxyl.zxs.yl"), getFromNode("json", data, "scyq.jxyl.zxs.yl.yln"), "yls", 1);
                        tree.expire(data);
                        for (var j = 0; j < trs.length; j++) {
                            var inputs = $(trs[j]).find("input");
                            for (var k = 0; k < $(inputs).length; k++) {
                                setToNode("value", data, "scyq.jxyl.zxs.yl.yl" + (j + 1) + "." + $(inputs[k]).attr("name"), $(inputs[k]).val());
                            }
                        }
                    }
                    if (zjpExist) {
                    ...
                    if (sdcExist) {
                        var scs = getFromNode("scs", data, "scyq.jxyl");
                        for (var j = scs.begin; j < scs.begin + scs.total; j++) {
                            var ss = getFromNode("ss", data, "scyq.jxyl.sdc" + j);
                            for (var k = ss.begin; k < ss.begin + ss.total; k++) {
                                setToNode("children", data, "scyq.jxyl.sdc" + j + ".s" + k + ".yl", $.extend(true, [], getFromNode("children", module, "scyq.jxyl.sdcn.sn.yl")));
                                tree.expire(data);
                                setToNode("value", data, "scyq.jxyl.sdc" + j + ".s" + k + ".yl.gs", getFromNode("value", arrangeData, "scyq.jxyl.sdc" + j + ".s" + k + ".yl.gs") || "");
                                var trs = $(".arrange .gxh_scyq_jxyl_sdc" + j + "_s" + k + "_yl_" + index).find("tbody tr:has(td:not(.dataTables_empty))");
                                drawNode(trs.length, getFromNode("json", data, "scyq.jxyl.sdc" + j + ".s" + k + ".yl"), getFromNode("json", data, "scyq.jxyl.sdc" + j + ".s" + k + ".yl.yln"), "yls", 1);
                                tree.expire(data);
                                for (var l = 0; l < trs.length; l++) {
                                    var inputs = $(trs[l]).find("input[name!=gs]");
                                    for (var m = 0; m < $(inputs).length; m++) {
                                        setToNode("value", data, "scyq.jxyl.sdc" + j + ".s" + k + ".yl.yl" + (l + 1) + "." + $(inputs[m]).attr("name"),
                                            $(inputs[m]).val())
                                    }
                                }
                            }
                    ...
                    if (sExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl");
                        for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                            setToNode("children", data, "scyq.jxyl.s" + j + ".yl", $.extend(true, [], getFromNode("children", module, "scyq.jxyl.sn.yl")));
                            tree.expire(data);
                            setToNode("value", data, "scyq.jxyl.s" + j + ".yl.gs", getFromNode("value", arrangeData, "scyq.jxyl.s" + j + ".yl.gs") || "");
                            var trs = $(".arrange .gxh_scyq_jxyl_s" + j + "_yl_" + index).find("tbody tr:has(td:not(.dataTables_empty))");
                            drawNode(trs.length, getFromNode("json", data, "scyq.jxyl.s" + j + ".yl"), getFromNode("json", data, "scyq.jxyl.s" + j + ".yl.yln"), "yls", 1);
                            tree.expire(data);
                            for (var k = 0; k < trs.length; k++) {
                                var inputs = $(trs[k]).find("input[name!=gs]");
                                for (var l = 0; l < $(inputs).length; l++) {
                                    setToNode("value", data, "scyq.jxyl.s" + j + ".yl.yl" + (k + 1) + "." + $(inputs[l]).attr("name"),
                                        $(inputs[l]).val())
                                }
                            }
                        }
                    ...
                    if (wgsExist) {
                        var ss = getFromNode("ss", data, "scyq.jxyl.wgs");
                        for (var j = ss.begin; j < ss.begin + ss.total; j++) {
                            setToNode("children", data, "scyq.jxyl.wgs.s" + j + ".yl", $.extend(true, [], getFromNode("children", module, "scyq.jxyl.wgs.sn.yl")));
                            tree.expire(data);
                            setToNode("value", data, "scyq.jxyl.wgs.s" + j + ".yl.gs", getFromNode("value", arrangeData, "scyq.jxyl.wgs.s" + j + ".yl.gs") || "");
                            var trs = $(".arrange .gxh_scyq_jxyl_wgs_s" + j + "_yl_" + index).find("tbody tr:has(td:not(.dataTables_empty))");
                            drawNode(trs.length, getFromNode("json", data, "scyq.jxyl.wgs.s" + j + ".yl"), getFromNode("json", data, "scyq.jxyl.wgs.s" + j + ".yl.yln"), "yls", 1);
                            tree.expire(data);
                            for (var l = 0; l < trs.length; l++) {
                                var inputs = $(trs[l]).find("input[name!=gs]");
                                for (var m = 0; m < $(inputs).length; m++) {
                                    setToNode("value", data, "scyq.jxyl.wgs.s" + j + ".yl.yl" + (l + 1) + "." + $(inputs[m]).attr("name"),
                                        $(inputs[m]).val())
                                }
                            }
                        }
                    ...
                    tree.expire(data);
                    var trs = $(".arrange .gxh_scyq_cpyq_sxfs_" + index).find("tbody tr:has(td:not(.dataTables_empty))");
                ...
                if (sjclExist) {
                    $.ajax({
                        url: "../user/reArrangeSuspendedNgWorkPlan",
                        method: "POST",
                        data: {"id": id}
                    }).success(function () {
                        $.ajax({
        ...
        function loadModule() {
            $.getJSON("../user/getNgWorkPlanModule", function (tmpl) {
                module = tmpl;
            }).fail(mesUtil.error);
        }
        ...
        function initDatatable() {
            ...
            gxqScyqCpyqSxfsDtTable = $gxqScyqCpyqSxfsTable.dataTable(datatableOption);
            ...
            gxqScyqJxylZxsGgDtTable = $gxqScyqJxylZxsGgTable.dataTable(datatableOption);
            gxqScyqJxylZxsYlDtTable = $gxqScyqJxylZxsYlTable.dataTable(datatableOption);
            ...
            gxhScyqJxylZxsGgDtTable = $gxhScyqJxylZxsGgTable.dataTable(datatableOption);
