$(function () {
    ...
    var dt = $('#tab').DataTable({
        ajax:{
            url:"../admin/internalForm/list?subForm=jsxjgb",
            type:"GET"
        },
        serverSide:'true',
        paging:true,
        "columns": [
            ...
            { "data": "xg_plies_3" },
            { "data": "xg_structure" },
            { "data": "xg_gg_center_wire" },
            { "data": "xg_gg_plies_1" },
            { "data": "xg_gg_plies_2" },
            { "data": "xg_gg_plies_3" },
            { "data": "zxg_nzcs" },
            { "data": "xg_plies_explain" },
            { "data": "wg_center_wire" },
            { "data": "wg_plies_1" },
            { "data": "wg_plies_2" },
            { "data": "wg_plies_3" },
            { "data": "wg_structure" },
            { "data": "wg_gg_center_wire" },
            { "data": "wg_gg_plies_1" },
            { "data": "wg_gg_plies_2" },
            { "data": "wg_gg_plies_3" },
            { "data": "wg_nzcs" },
    ...
    $("#tab").on("click", "a", function (e) {
        var id = $(this).attr("id");
        $.post("../admin/internalForm/get?subForm=jsxjgb", {id: id}, function (data) {
            $('#submit').hide();
            $('#update,#delete').show();
            $('.modal-title').text("查看金属芯结构表");
            ...
            buttons: [
                ...
                },
                {
                    ...
                    callback: function () {
                        ...
                        $.ajax(
                            {
                                url: "../admin/internalForm/del?subForm=jsxjgb",
                                type: "DELETE",
                                data: {id: id}
                            }).success(function () {
    ...
    $('form').formValidation({
        ...
        if(handle=="create"){
            $.ajax({
                url: "../admin/internalForm/create?subForm=jsxjgb",
                type: 'POST',
                data: $form.serialize()
            ...
            $.ajax({
                url: "../admin/internalForm/update?subForm=jsxjgb",
                type: 'POST',
