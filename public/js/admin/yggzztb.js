$(function () {
    ...
    var dt = $('#tab').DataTable({
        ajax:{
            url:"../admin/internalForm/list?subForm=yggzztb",
            type:"GET"
        },
        serverSide:'true',
        paging:true,
    ...
    $("#tab").on("click", "a", function (e) {
        var id = $(this).attr("id");
        $.post("../admin/internalForm/get?subForm=yggzztb", {id: id}, function (data) {
            $('#submit').hide();
            $('#update,#delete').show();
            $('.modal-title').text("查看员工工作状态记录");
            ...
            buttons: [
                ...
                },
                {
                    ...
                    callback: function () {
                        ...
                        $.ajax(
                            {
                                url: "../admin/internalForm/del?subForm=yggzztb",
                                type: "DELETE",
                                data: {id: id}
                            }).success(function () {
    ...
    $('form').formValidation({
        ...
        if(handle=="create"){
            $.ajax({
                url: "../admin/internalForm/create?subForm=yggzztb",
                type: 'POST',
                data: $form.serialize()
            ...
            $.ajax({
                url: "../admin/internalForm/update?subForm=yggzztb",
                type: 'POST',
