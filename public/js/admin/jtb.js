$(function () {
    ...
    var dt = $('#tab').DataTable({
        ...
        "columns": [
            ...
            { "data": "operating_rate" },
            { "data": "fact_capacity" },
            { "data": "fact_std_capacity" },
            { "data": "length_error_rate" },
            { "data": "cone_use_cycle" },
            { "data": "total_down_time" },
            { "data": "down_count" },
            { "data": "total_repair_time" },
            { "data": "twist_contraction_rate" },
            { "data": "vender" },
            { "data": "opened_time" },
            { "data": "installation_site" },
    ...
    $("#tab").on("click", "a", function (e) {
        var id = $(this).attr("id");
        $.post("../admin/internalForm/get?subForm=jtb", {id: id}, function (data) {
            $('#submit').hide();
            $('#update,#delete').show();
            $('.modal-title').text("查看机台");
            ...
            buttons: [
                ...
                },
                {
                    ...
                    callback: function () {
                        ...
                        $.ajax(
                            {
                                url: "../admin/internalForm/del?subForm=jtb",
                                type: "DELETE",
                                data: {id: id}
                            }).success(function () {
    ...
    $('form').formValidation({
        ...
        if(handle=="create"){
            $.ajax({
                url: "../admin/internalForm/create?subForm=jtb",
                type: 'POST',
                data: $form.serialize()
            ...
            $.ajax({
                url: "../admin/internalForm/update?subForm=jtb",
                type: 'POST',
