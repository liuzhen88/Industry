$(function () {
    ...
    var dt = $('#tab').DataTable({
        ajax:{
            url:"../admin/internalForm/list?subForm=plk",
            type:"GET"
        },
        serverSide:'true',
        paging:true,
    ...
    $("#tab").on("click", "a", function (e) {
        var id = $(this).attr("id");
        $.post("../admin/internalForm/get?subForm=plk", {id: id}, function (data) {
            $('#submit').hide();
            $('#update,#delete').show();
            $('.modal-title').text("查看坯料库");
            ...
            buttons: [
                ...
                },
                {
                    ...
                    callback: function () {
                        ...
                        $.ajax(
                            {
                                url: "../admin/internalForm/del?subForm=plk",
                                type: "DELETE",
                                data: {id: id}
                            }).success(function () {
    ...
    $('form').formValidation({
        ...
        if(handle=="create"){
            $.ajax({
                url: "../admin/internalForm/create?subForm=plk",
                type: 'POST',
                data: $form.serialize()
            ...
            $.ajax({
                url: "../admin/internalForm/update?subForm=plk",
                type: 'POST',
